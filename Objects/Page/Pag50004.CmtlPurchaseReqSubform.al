...
page 50004 "Cmtl Purchase Req. Subform"
            ...
            repeater(Control1)
            {
                ...
                field("Variant Code"; Rec."Variant Code")
                {
                    ...
                    begin
                        ...
                        //VariantCodeMandatory := Item.IsVariantMandatory(Rec.Type = Rec.Type::Item, Rec."No.");//Rajesh
                    end;
                }
