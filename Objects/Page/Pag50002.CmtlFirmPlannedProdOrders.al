...
page 50002 "Cmtl Firm Planned Prod. Orders"
#pragma warning restore AA0215
{
    ...
    SourceTableView = sorting("Presentation Order") WHERE(Status = CONST("Firm Planned"));
    UsageCategory = Lists;
        ...
        area(navigation)
        {
            group("Pro&d. Order")
            {
                ...
                group("E&ntries")
                {
                    ...
                    action(DeleteFirmPlanned1)
                    {
                        ApplicationArea = All;
                        Caption = 'Delete Record';
                        ToolTip = 'Delete all the firm planned record';
                        Image = Delete;
                        trigger OnAction()
                        begin
                            DeleteFirmPlanned();
        ...
        area(processing)
        {
            group("F&unctions")
            {
                ...
                action("Change &Status")
                {
                    ...
                    Image = ChangeStatus;
                    RunObject = Codeunit "Cmtl Prod. Order Status Mgt.";
    ...
    local procedure DeleteFirmPlanned()
    var
    begin
