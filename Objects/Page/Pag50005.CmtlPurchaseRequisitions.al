...
page 50005 "Cmtl Purchase Requisitions"
#pragma warning restore AA0215
{
    AdditionalSearchTerms = 'rfq,request for quote,purchase requisition';
    ApplicationArea = Suite;
    Caption = 'Purchase Requisitions';
    CardPageID = "Cmtl Purchase Requisition";
    DataCaptionFields = "Buy-from Vendor No.";
    Editable = false;
    PageType = List;
    QueryCategory = 'Purchase Requisitions';
    RefreshOnActivate = true;
    SourceTable = "Purchase Header";
    SourceTableView = WHERE("Document Type" = CONST(Quote), "Is Requisition" = const(true));
    UsageCategory = Lists;
    ...
    actions
    {
        ...
        area(Promoted)
        {
            ...
            {
                Caption = 'Requisition', Comment = 'Generated from the PromotedActionCategories property index 5.';
